...
//
// Solidity: function transferForm(address from, address to, uint256 tokens) returns(bool success)
func (_Token *TokenTransactor) TransferForm(opts *bind.TransactOpts, from common.Address, to common.Address, tokens *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "transferForm", from, to, tokens)
}

// TransferForm is a paid mutator transaction binding the contract method 0x3112ae5b.
//
// Solidity: function transferForm(address from, address to, uint256 tokens) returns(bool success)
func (_Token *TokenSession) TransferForm(from common.Address, to common.Address, tokens *big.Int) (*types.Transaction, error) {
	return _Token.Contract.TransferForm(&_Token.TransactOpts, from, to, tokens)
}

// TransferForm is a paid mutator transaction binding the contract method 0x3112ae5b.
//
// Solidity: function transferForm(address from, address to, uint256 tokens) returns(bool success)
func (_Token *TokenTransactorSession) TransferForm(from common.Address, to common.Address, tokens *big.Int) (*types.Transaction, error) {
	return _Token.Contract.TransferForm(&_Token.TransactOpts, from, to, tokens)
}
